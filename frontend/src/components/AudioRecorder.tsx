...
// Simple utility functions (moved inline)
...
async function webmFixDuration(blob: Blob, duration: number, mimeType: string): Promise<Blob> {
    // Simple implementation - just return the original blob
    // In a real app, you might want to implement proper duration fixing
    return blob;
}
...
export default function AudioRecorder(props: {
    ...
    // Cleanup effect for stopping tracks
    useEffect(() => {
        return () => {
            if (streamRef.current) {
